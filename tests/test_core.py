...
from ocr_catalogue.app import export_download_name
...
class ExportTests(unittest.TestCase):
    ...
    def test_export_uses_uploaded_catalogue_name(self):
        self.assertEqual(
            export_download_name("OC10-2026 MPX IMP.pdf", "xlsx"),
            "produits-OC10-2026 MPX IMP.xlsx",
        )

    def test_export_name_is_safe_on_windows(self):
        self.assertEqual(
            export_download_name('Catalogue: OC10?.pdf', "csv"),
            "produits-Catalogue_ OC10_.csv",
        )
